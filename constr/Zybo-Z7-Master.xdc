...
create_clock -period 8.000 -name sys_clk -waveform {0.000 4.000} -add [get_ports CLK_I]
...
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports VGA_VS_O]
